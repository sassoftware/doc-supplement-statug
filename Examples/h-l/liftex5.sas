...
/*                                                              */
/*    NAME: LIFTEX5                                             */
/*   TITLE: Documentation Example 5 for PROC LIFETEST           */
/* PRODUCT: STAT                                                */
/*  SYSTEM: ALL                                                 */
/*    KEYS: RMST, RMTL                                          */
/*   PROCS: LIFETEST                                            */
/*    DATA: Originally from R.L. Prentice (1974) included in    */
/*          Appendix 1 of J.D. Kalbfleisch and R.L. Prentice    */
/*          (1980): The Statistical Analysis of Failure Time    */
/*          Data                                                */
/*     REF: STAT User's Guide, PROC LIFETEST Chapter            */
/*    MISC:                                                     */
/****************************************************************/
data VALung;
   drop check m;
...
proc lifetest data=VALung rmst;
   time SurvTime*Censor(1);
   strata Cell / diff=all adj=sidak;
run;
