...
/*                                                              */
/*    NAME: hpgenex1                                            */
/*   TITLE: Example 1 for PROC HPGENSELECT                      */
/*          Model Selection                                     */
/* PRODUCT: STAT                                                */
/*  SYSTEM: ALL                                                 */
...
100 observations on a count response variable Y, and five numerical
categorical variables C1--C5. A forward selection technique is used
to select the variables for use in a main effects log linked
