 ...
 /*                                                              */
 /*    NAME: CANCOREG                                            */
 /*   TITLE: Regression Options for PROC CANCORR                 */
 /* PRODUCT: SAS/STAT                                            */
 /*  SYSTEM: ALL                                                 */
...
title 'Canonical Correlation Analysis of Fitness Club Data';
...
proc cancorr data=fit short vdep wdep smc stb t probt
   ...
   title2 'Middle-aged Men in a Health Fitness Club';
   title3 'Data Courtesy of Dr. A. C. Linnerud, NC State Univ.';
run;
