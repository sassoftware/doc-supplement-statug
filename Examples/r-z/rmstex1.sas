...
/*                                                              */
/*    NAME: RMSTEX1                                             */
/*   TITLE: Example 1 for PROC RMSTREG                          */
/* PRODUCT: STAT                                                */
/*  SYSTEM: ALL                                                 */
/*    KEYS: RMST regression vs PH and AFT models                */
/*   PROCS: RMSTREG                                             */
/*    DATA:                                                     */
/*                                                              */
/*     REF: PROC RMSTREG, EXAMPLE 1                             */
/*    MISC:                                                     */
/****************************************************************/
...
proc rmstreg data=Myeloma tau=50;
   model Time*VStatus(0)=LogBUN HGB / method=ipcw link=log;
run;

proc rmstreg data=Myeloma tau=50;
   model Time*VStatus(0)=LogBUN HGB / method=ipcw link=linear;
   store rr;
run;
