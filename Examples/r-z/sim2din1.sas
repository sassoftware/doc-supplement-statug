...
/*    DATA:                                                     */
/*                                                              */
/*     REF: PROC SIM2D, INTRODUCTORY EXAMPLE 1.                 */
/*    MISC:                                                     */
/****************************************************************/


/* Using PROC SIM2D for Simulations ----------------------------*/
...
/* Investigate random field variability across the region ------*/
...
proc sim2d data=thick outsim=sim plot=(observ means);
   coordinates xc=East yc=North;
   simulate var=Thick numreal=5000 seed=79931
      scale=7.2881 range=30.6239 nugget=1e-8 form=gauss;
   mean 40.1173;
